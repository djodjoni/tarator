 ...
 */
final class TaratorAnalyticsUsageTracker implements UsageTracker {
  ...
  private TaratorAnalyticsUsageTracker(Builder builder) {
  ...
  public static class Builder {
    ...
    private Uri analyticsUri = new Uri.Builder()
      ...
      .path("collect")
      .build();
    private String trackingId = "UA-61940302-1";
    ...
    public UsageTracker buildIfPossible() {
      ...
      return new TaratorAnalyticsUsageTracker(this);
    }
