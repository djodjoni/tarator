    ...
    public static Matcher<View> withContentDescription(final int resourceId) {
        return new TypeSafeMatcher<View>() {
            ...
            public boolean matchesSafely(View view) {
                ...
                return null != this.expectedText ? this.expectedText.equals(view.getContentDescription().toString()) : false;
            }
        };
    }
            ...
            public boolean matchesSafely(View view) {
                if (visibility.getValue() == View.VISIBLE) {
                    ...
                    while (view.getParent() != null && view.getParent() instanceof View) {
                        ...
                        if (visibility.value != view.getVisibility()) {
                            return false;
                        }
                    }
                    return true;
                } else {
                    if (view.getVisibility() == visibility.value) {
                        return true;
                    }
                    while (view.getParent() != null && view.getParent() instanceof View) {
                        view = (View) view.getParent();
