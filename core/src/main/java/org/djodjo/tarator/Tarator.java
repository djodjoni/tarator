...
import org.djodjo.tarator.iteraction.DataInteraction;
...
public final class Tarator {
  ...
  /**
   * Creates an {@link ViewInteraction} for a given view. Note: the view has
  ...
  public static TextViewInteraction onTextView(final Matcher<View> viewMatcher) {
    final Matcher<View> specViewMatcher = allOf(isAssignableFrom(TextView.class), viewMatcher);
    return taratorGraph().plus(new ViewInteractionModule(specViewMatcher)).get(TextViewInteraction.class);
  }

  public static ButtonInteraction onButton(final Matcher<View> viewMatcher) {
    final Matcher<View> specViewMatcher = allOf(isAssignableFrom(Button.class), viewMatcher);
    return taratorGraph().plus(new ViewInteractionModule(specViewMatcher)).get(ButtonInteraction.class);
  }

  public static CompoundButtonInteraction onCompoundButton(final Matcher<View> viewMatcher) {
    final Matcher<View> specViewMatcher = allOf(isAssignableFrom(CompoundButton.class), viewMatcher);
    return taratorGraph().plus(new ViewInteractionModule(specViewMatcher)).get(CompoundButtonInteraction.class);
  }
