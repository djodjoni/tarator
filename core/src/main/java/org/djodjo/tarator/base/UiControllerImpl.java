...
import org.djodjo.tarator.base.IdlingResourceRegistry.IdleNotificationCallback;
...
final class UiControllerImpl implements UiController, Handler.Callback {
    ...
    public boolean injectString(String str) throws InjectEventSecurityException {
        ...
        checkNotNull(events, "Failed to get events for string %s (i.e. current IME does not understand how to translate the string into key events). As a workaround, you can use replaceText action to set the text directly in the EditText field.", str);
